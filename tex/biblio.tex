...

{
  ...
  \nref[Figure]{fig:oc-illustration}: Inspiré par \eng{\textit{Hints of Spring in the Atlantic}, Image of the Day 2020-03-10}.
  ...
  Images obtenues sur \href{https://worldview.earthdata.nasa.gov}{Worldview \as{eosdis}}, données \engquote{Corrected Reflectance (True Color) Terra/\as{modis}} et \engquote{Chlorophyll a Aqua/\as{modis}}.
