...

{
  ...
  \nref[Figure]{fig:finescales-photos}: \eng{Image of the Day 2015-08-23, \textit{Blooming Baltic Sea.}}
  Texte par Kathryn Hansen, carte par Joshua Stevens, images par Norman Kuring.
  \eng{NASA Earth Observatory.}
  \textsc{url:} \glsurl{eo-sms}

  \medskip

  \nref[Figure]{fig:oc-illustration}: \eng{Image of the Day 2020-03-10, \textit{Hints of Spring in the Atlantic.}}
