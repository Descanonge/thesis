...
\begin{figure}
  ...
  \captionT{Climatologie de la température dans, et hors des fronts}{%
    Valeurs médianes de la températures dans les fronts faibles (bleu), les fronts forts (vert), et le background (rouge), pour les biomes subtropicaux permanent (à gauche) et saisonnier (à droite).
