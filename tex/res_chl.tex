...
Les fronts affectent la croissance et la phénologie du phytoplancton en réduisant localement la stratification et en augmentant les apports en nutriments.
...
L'imagerie satellitaire permet de quantifier ces changements induits dans le phytoplancton sur un grand nombre de fronts et à des échelles synoptiques. Ici, nous avons utilisé vingt ans de données satellitaires sur la température de surface (SST) et la \al{chl} (\as{chl}) dans une vaste région entourant le Gulf Stream pour quantifier l'impact des fronts sur la \as{chl} de surface (utilisée comme indicateur du phytoplancton) dans trois biorégions contrastées, de l'oligotrophe à la floraison, et tout au long de l'année.
...
Nous avons comparé les distributions de \as{chl} sur les fronts forts, sur les fronts faibles et à l'extérieur des fronts dans les trois biorégions.
Nous avons évalué trois paramètres, l'excès de \as{chl} au-dessus des fronts à l'échelle locale des fronts, l'excédent de \as{chl} induit à l'échelle biorégionale et le retard dans l'apparition de la floraison printanière au-dessus des fronts.
Nous avons constaté que les fronts faibles sont associés à un excès local de \as{chl} plus faible que les fronts forts, mais comme ils sont aussi plus fréquents, ils contribuent de la même manière à l'excédent régional de \as{chl}.
Nous avons également constaté que l'excès local de \as{chl} était deux à trois fois plus important dans la biorégion présentant une efflorescence printanière que dans la biorégion oligotrophe, ce qui peut s'expliquer en partie par le transport de nutriments par le Gulf Stream. Nous avons trouvé de fortes variations saisonnières dans l'amplitude de l'excès de \as{chl} au-dessus des fronts, et nous montrons des périodes de déficit de \as{chl} au-dessus des fronts au nord de 45°N que nous attribuons à la subduction.
...
Nos résultats suggèrent que l'impact spectaculaire des fronts à l'échelle locale (jusqu'à \pct{+60}) est plus limité lorsqu'il est considéré à l'échelle régionale des biorégions (moins de \pct{+5}), mais qu'il peut néanmoins avoir des implications pour l'ensemble de l'écosystème de la région.
