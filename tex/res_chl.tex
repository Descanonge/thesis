...
\begin{figure}
  ...
  \captionT{Corrélation de l'augmentation de Chl-\textit{a} avec la surface couverte par les fronts pour différentes configuration du HI}{%
    Les valeurs médianes de \as{chl} dans les fronts sont négativement corrélées à la surface occupée par les fronts.
    On soustrait à ces variables leur moyenne sur l'ensemble des configurations testées (taille de fenêtre et coefficients de normalisation) afin passer outre leur dépendances en temps et région.
  }
...
\begin{figure}
  ...
  \captionT{Climatologie de la température dans les fronts}{%
  }
