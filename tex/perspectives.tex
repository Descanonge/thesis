...
\textnote{Il serait intéressant de se pencher sur des méthodes ne reposant pas sur une variable dont il faudrait prendre le seuil, comme celle de \textcite{cayula_1995} par exemple. L'intensité et la largeur des fronts serait ainsi à déterminer de manière indépendante, par des méthodes à définir.}
