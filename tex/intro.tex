...
Notamment, elles peuvent être déterminée à partir du champ de vitesses horizontales en utilisant l'équation \guil{omega} (\cite{hoskins_1978}).
La mission \as{swot}, lancée en décembre 2022, promet d'ailleurs de pouvoir accéder à ce champ de vitesses horizontales à une résolution sans précédent (\cite{dovidio_2019}).
