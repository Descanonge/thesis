...
À cette échelle \encadra{typiquement en dessous du rayon de déformation de Rossby} apparaissent des phénomènes dynamiques particuliers, aujourd'hui relativement bien compris (\cite{mcwilliams_2016, mcwilliams_2019, gula_2022, taylor_2023}).
L'évaluation de l'impact ces phénomènes sur les cycles biogéochimiques reste cependant encore un défi, à la fois lorsque l'on considère leur impact local, et encore plus si l'on se penche sur les conséquences sur le paysage biogéochimique global évoqué plus haut.
...
\begin{note}
  ...
  Les deux échelles sont fortement couplées (\cite{sasaki_2020, balwada_2022, naveiragarabato_2022, taylor_2023}).
  Il est d'ailleurs parfois difficile d'isoler leurs impacts respectifs (\cite{uchida_2019, freilich_2019, balwada_2021}), et sont ainsi parfois groupées sous l’appellation \guil*{fines échelles}.
\end{note}

effets subméso sur circulation moyenne (upscale connection)

Regardons les effets de la subméso sur la biogéochimie.
(Notamment deux en particuliers.)
