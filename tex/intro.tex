...
Les algorithmes dits \emph{empiriques} font l'hypothèse que les quantitées de \as{nap} et \as{cdom} co"-varient avec le phytoplancton, et qu'ils ne jouent donc pas dans la relation entre \as{chl} et réflectances.
...
Certains algorithmes dits semi"-analytiques cherchent à représenter les effets de tous les composants optiques.
