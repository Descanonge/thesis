...
\begin{figure}[!h]
  ...
  \captionT{Les couleurs du Gulf Stream par satellite}{%
    Image en fausses couleurs de l'océan Atlantique Nord le \frenchdate{2020}{02}{23}, données \as{modis} \sur~Terra.
    Mise en image réalisée en combinant les données de réflectance corrigée et de \al{chl}, travail inspiré de celui de Norman Kuring. {\footnotesize\textcopyright Clément Haëck}
  }
