...
Les données satellite manquent ainsi la biomasse plus en profondeur, potentiellement importante (\as{ie} le \engquote{Deep Chlorophyll Maximum}).
...
Les mesures \as{hplc}\marginnote{\al{hplc}} permettent par exemple d'accéder à la concentration exacte de la \al{chl} mais également d'autres pigments auxiliaires, donnant ainsi une meilleure idée de la composition de la communauté phytoplanctonique.
...
Certaines mesures, physique ou biologiques \encadra{notamment les profils en profondeur} prennent du temps, ce qui se répercute sur la distance d'échantillonage.
