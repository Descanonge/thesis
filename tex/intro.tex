...
Il est donc possible que pour certains fronts thermique, la variation de température \guil{compensée} par une variation de salinité, donnant ainsi une densité constante.
Dans la région de l'Atlantique Nord, des transects sont réalisés régulièrement par un navire d'opportunité, l'Oleander.
Des résultats suggèrent que la salinité n'intervient que peu dans les variations de densité (\cite{flagg_2006}).
