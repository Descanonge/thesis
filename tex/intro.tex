...
Nous nous penchons donc dans ce travail sur les moyens de quantifications, par satellite, des effets que ces processus ont sur le phytoplancton; en particulier les effets qu'ont les \emph{fronts de submésoéchelle} sur la \emph{\al{chl}}, que nous utilisons comme proxy de la biomasse totale de ce dernier.
...
\begin{tcolorbox}[
  ...
  \begin{list}{}{
    ...
    \item Comment est-ce que l'augmentation de \al{chl} dans les fronts est conditionnée par leur intensité ?
