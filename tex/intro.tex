...
\begin{figure}
  ...
  \captionT{Schéma de la pompe biologique}{%
    Tiré de \cite{levy_2023}, figure~1.
...
Dans la section précédente, la majorité des méthodes opèrent sur les données satellites de températures, qui est utilisée comme proxy de la densité.
