...
Tous les codes utilisés \encadra{accompagné d'une documentation} sont disponibles sur un dépôt Git public\footnote{\glsurl{gitlab}} hébergé par l'\abbrv{IN2P3}~(Institut National de Physique Nucléaire et de Physique des Particules, CNRS).
...
Une partie des codes (qui gère les paramètres et les données d'entrée) a des objectifs généraux et pourrait également être distribuée indépendamment.
...
Je n'ai réalisé que peu de trajets faits en avions, aucune campagne en mer, et je n'ai pas comptabilisé le coût carbone informatique (qui sont typiquement les trois postes les plus consommateurs pour un travail académique); ainsi la majeure partie de cette estimation correspond à la vie en laboratoire.
