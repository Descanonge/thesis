...
% \begin{keypoints}
% \item Over SST fronts in the Gulf Stream region Chlorophyll\nobreakdash-\emph{a} is enhanced by up to a factor two and the bloom onsets earlier by up to two weeks.
% \item The enhancement intensity increases significantly with the strength of the front.
% \item The net contribution of fronts to Chlorophyll\nobreakdash-\emph{a} enhancement over the Gulf Stream region is less than 5\%.
% \end{keypoints}
...
Here we used twenty years of SST and Chlorophyll\nobreakdash-\emph{a} satellite data in a large region surrounding the Gulf Stream to quantify the impact of fronts on phytoplankton in contrasting regimes, from oligotrophy to bloom, and throughout the year.
...
We compared Chlorophyll\nobreakdash-\emph{a} distributions over strong fronts, weak fronts and outside of fronts.
We assessed three metrics, the local enhancement of Chlorophyll\nobreakdash-\emph{a} over fronts, the global enhancement of Chlorophyll\nobreakdash-\emph{a} due to fronts at the scale of the region, and the lag in spring bloom onset due to fronts.
We found that weak fronts lead to a local enhancement of Chlorophyll\nobreakdash-\emph{a} weaker than strong fronts, but because they are also more frequent they contribute equally to the regional Chlorophyll\nobreakdash-\emph{a} budget.
We also find the the local enhancement of Chlorophyll\nobreakdash-\emph{a} was two to three times larger for the spring bloom than in the oligotrophic subtropical gyre.
...
\begin{figure*}
  ...
  \caption{
    Permanent subtropical biome: local impact of fronts on Chl\nobreakdash-\emph{a} by range of latitudes in the biome.
    (a-c-e) Chl\nobreakdash-\emph{a} median values over weak fronts (blue) and background (red), (b-d-f)  corresponding local excess of Chl\nobreakdash-\emph{a} in weak fronts computed as the relative difference of Chl\nobreakdash-\emph{a} in fronts and in the background.
    The plain lines represent the climatological mean, and the envelopes mark the standard deviation over the period 2000--2020.
...
\begin{figure*}
  ...
  \caption{
    Seasonal subtropical biome: local impact of fronts on Chl\nobreakdash-\emph{a}  by range of latitudes in the biome.
    (a-c-e) Chl\nobreakdash-\emph{a} median values over weak fronts (blue), strong fronts (green) and background (red), (b-d-f)  corresponding local excess of Chl\nobreakdash-\emph{a} in weak and strong fronts computed as the relative difference of Chl\nobreakdash-\emph{a} in fronts and in the background.
    The plain lines represent the climatological mean, and the envelopes mark the standard deviation over the period 2000--2020.
...
\begin{figure*}
  ...
  \caption{
    Subpolar biome: local impact of fronts on Chl\nobreakdash-\emph{a}  by range of latitudes in the biome.
    (a-c-e) Chl\nobreakdash-\emph{a} median values over weak fronts (blue), strong fronts (green) and background (red), (b-d-f)  corresponding local excess of Chl\nobreakdash-\emph{a} in weak and strong fronts computed as the relative difference of Chl\nobreakdash-\emph{a} in fronts and in the background.
    The plain lines represent the climatological mean, and the envelopes mark the standard deviation over the period 2000--2020.
