...
In the permanent subtropical biome (Fig.~\ref{fig:latbands-s}), the excess is only detectable north of~\ang{25}N and remains modest (\(\am{exces}<\pct{10}\)); it reaches its maximum of~\pct{10} at the beginning and end of the production season.
