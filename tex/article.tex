
{
  ...
  \foreignlanguage{french}{
    ...
    Accepté après révisions mineures, et sous presse.\\
    Pre-print disponible sur EGUsphere (\textsc{doi}:~\href{\glsentryurl{preprint-bgs}}{\textsf{\glsentrydoi{preprint-bgs-doi}}}).
  }
}
