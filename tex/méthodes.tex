...
Afin d'optimiser les calculs et le stockage, j'ai transformé chaque image \abbrv{2D} de SST et de \as{chl} en une serie d'histogrammes.
...
\begin{figure}
  ...
  \captionT{Mesure des dates de début et de fun du bloom}{%
    Séries temporelles de la médiane de \as{chl}~(a) et de sa dérivé~(b), pour l'année~2015 et la bande de latitude~\latlonRange{40}{45N}.
...
\begin{figure}
  ...
  \captionT{Différences de phénologie du bloom entre fronts et background}{%
    Séries temporelles de la médiane de \as{chl}~(a) et de sa dérivé~(b), pour le \eng{background}~(rouge), les fronts faibles~(bleu), et les fronts forts~(vert), pour l'année~2015 et la bande de latitude~\latlonRange{40}{45N}.
