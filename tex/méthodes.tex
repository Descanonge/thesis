...
\begin{note}
  Bien que notre zone d'étude s'étende à des (relativement) hautes latitudes~(\ang{\approx55}N), nous ne considérons pas les différences de distances zonales et méridionales.
...
\begin{figure}
  \captionT{Bathymétrie de la zone d'étude}{%
    Bathymétrie de la zone d'étude.
    L'isobath~\qty{-1500}{\m} est indiqué en rouge.}
...
\begin{figure}
  ...
  \captionT{Séparation de la région d'étude en sous-régions}{
...
\begin{figure}
  ...
  \captionT{Délimitation des biomes subtropical permanent et subpolaire par température seuil}{
    ...
    Détermination de la température de seuil séparant les biomes subtropical permanent et subpolaire pour le 22 avril 2007.
