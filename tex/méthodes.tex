...
Ce principe de calcul de bimodalité s'apparente à celle de \textcite{cayula_1992} (voir \nref{sec:detection-front}).
Bien que cette dernière soit appliquée avec succès pour la détection de front, il apparaît que cette méthode nécessite de construire un histogramme d'une résolution suffisante, ce qui s'avère difficile aux échelles où nous travaillons.
