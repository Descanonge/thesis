...
Nous avons réalisé des test de sensibilité à certains paramètres de cette méthode, à savoir la taille de la fenêtre glissante et le choix des coefficients de normalisation~(\cref{fig:ts-sensitivity}, \cref{sec:sensibilite-parametres}).
