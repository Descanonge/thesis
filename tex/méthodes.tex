...
Ainsi on définit le surplus~\ab{surplus} de \ab{chl} (\guil{biome surplus} dans l'article \cref{sec:article-bg}, \cref*{chp:res-chl}) dans toute un biome comme la différence relative entre la moyenne de \ab{chl} dans tout un biome et la moyenne dans le background:
\begin{equation}
