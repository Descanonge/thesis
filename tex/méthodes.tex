...
Enfin, le produit~\abbrv{L4} regroupe l'ensemble des capteurs en utilisant le schéma d'intégration variationnelle \verb|NEMOVAR| intégré dans le système \ab{ostia} (\cite{good_2020}).
...
Les données produites par \review{TODO infos et ref}, disponibles à la résolution~\resol{1}{12} (soit environ~\qty{8}{\km})\footfullcite{sst_reanalyses}.
