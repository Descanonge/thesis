...
** Finir corrections intro inès
** Annexe sur création image préambule
** Questions Inès
- différence entre nutriments (inorganiques)
- Michelle Fieux dit une gyre :) euh vérifier
...
* Traduction
- mixed layer instability -> instabilité de couche de mélange ?
** mots d'emprunts
